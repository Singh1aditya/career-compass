    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{selected ? "Edit Company" : "Add Company"}</DialogTitle>
            </DialogHeader>
            <div className="space-y-3">
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={2}
                  placeholder="Recent funding, job postings..."
                />
              </div>
              <div className="flex items-center gap-2">
                <Switch
                  checked={form.watchlist}
                  onCheckedChange={(c) => setForm({ ...form, watchlist: c })}
                />
        ...
        <div className="space-y-2">
          {filtered.map((c) => (
            <Card
              ...
              onClick={() => navigate({ to: `/companies/${c.id}` })}
            >
              <CardContent className="p-4 flex items-center justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1 text-sm text-muted-foreground">
                    ...
                    {c.hiring_signals && (
                      <span>
                        • {c.hiring_signals.slice(0, 50)}
                        {c.hiring_signals.length > 50 ? "..." : ""}
                      </span>
                    )}
                  </div>
                </div>
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  >
                    <Star
                      className={`h-3.5 w-3.5 ${c.watchlist ? "text-warning fill-warning" : "text-muted-foreground"}`}
                    />
                  </Button>
                </div>
              </CardContent>
